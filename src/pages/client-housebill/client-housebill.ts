...
import $ from 'jquery';
import { BillsDetailPage } from '../bills-detail/bills-detail';
/**
...
@IonicPage()
@Component({
  selector: 'page-client-housebill',
  templateUrl: 'client-housebill.html',
})
export class ClientHousebillPage {
  ...
  House_Detail(item,i) {
    ...
    // $("#bg_"+i).addClass({'background-color': '#dddddd'});
      ...
      if (item.status == "Uncolllected") {
        ...
        this.navCtrl.push(BillsDetailPage, {}, animationsOptions);
      }
